...
function addremove() { //add remove bt-io time pair add event listener
    ...
    for (let i = 0; i < process; i++) {
        addbtns[i].onclick = () => {
            ...
            newcell2.innerHTML = '<input type="number" min="1" step="1" value="1" class="form-control" style="min-width: 200px;">';
            ...
            newcell4.innerHTML = '<input type="number" min="1" step="1" value="1" class="form-control" style="min-width: 200px;">';
...
function addProcess() {
    ...
    let rowHTML1 = `
                          ...
                          <td class="priority hide" rowspan="2"><input type="number" min="1" step="1" value="1" class="form-control" style="min-width: 200px;"></td>
                          <td class="arrival-time" rowspan="2"><input type="number" min="0" step="1" value="0" class="form-control" style="min-width: 200px;"> </td>
                          <td class="process-time cpu process-heading" colspan="">CPU</td>
                          <td class="process-btn"><button type="button" class="add-process-btn btn btn-primary">+</button></td>
                          <td class="process-btn"><button type="button" class="remove-process-btn btn btn-danger">-</button></td>
                      `;
    let rowHTML2 = `
                           <td class="process-time cpu process-input"><input type="number" min="1" step="1" value="1" class="form-control" style="min-width: 200px;"> </td>
                      `;
